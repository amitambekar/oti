...
class Adminpackages_model extends CI_Model
{
    ...
    function addPackage($package_name,$package_amount,$package_type,$package_desc){
		$this->db->trans_start();
        $array = array('package_amount' => $package_amount,'package_name'=>$package_name,'package_type'=>$package_type,'package_desc'=>htmlspecialchars($package_desc), 'package_created_date' => date("Y-m-d H:i:s"),'package_status'=>'active');
		$this->db->set($array);
